...
const packages = [
  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Evening_view%2C_City_Palace%2C_Udaipur.jpg/1200px-Evening_view%2C_City_Palace%2C_Udaipur.jpg",
  },
  {
    title: "Goa",
    description:
  ...
  return (
    <>
      ...
      <section class="vacation-gallery">
        <div class="vacation-card">
          <img
            src="https://miro.medium.com/v2/resize:fit:4000/1*BFo1H50wagEG88xhCex9ZA.jpeg"
            alt="Palm Swing"
          />
        </div>
        <div class="vacation-card">
      ...
      <section className="company-intro">
        <div className="company-intro__text">
          <h4 className="company-intro__brand">
            Tree House luxury vacations Pvt. Ltd.
          </h4>
          ...
          <p className="company-intro__desc">
            At Tree House Luxury Vacations, we believe that every journey should
        ...
        <div className="company-intro__image">
          <img
            src="https://treehouseluxuryvacations.com/images_new/logo_icon.png"
            alt="Tree House Logo"
          />
        </div>
      ...
      <div className="explore-content">
        <div className="text-area">
          ...
          <p className="description">
            At Tree House Luxury Vacations, we are committed to transforming every journey into a perfect harmony of luxury and comfort, ensuring an exceptional experience from start to finish. Renowned as a premier name in the holiday hospitality industry, we specialize in crafting unforgettable travel moments.
          </p>
    ...
    <section className="associates-section">
      ...
      <div className="logo-row">
        <img src="/logos/makemytrip.png" alt="MakeMyTrip" />
        <img src="/logos/trivago.png" alt="Trivago" />
        <img src="/logos/goibibo.png" alt="Goibibo" />
        <img src="/logos/booking.png" alt="Booking.com" />
        <img src="/logos/agoda.png" alt="Agoda" />
        <img src="/logos/easemytrip.png" alt="EaseMyTrip" />
      </div>
      ...
      <div className="features-row">
        ...
        <div className="feature-box">
          <img src="/icons/global.png" alt="Coverage" />
          <h5>Coverage</h5>
          <p>
